...
parser.add_argument('-s', '--sdate', required=True, help='Start Date')
parser.add_argument('-e', '--edate', required=True, help='End Date')
...
prompt = prompt.replace('<sdate>', args.sdate)
prompt = prompt.replace('<edate>', args.edate)
